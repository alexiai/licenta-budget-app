import { Transaction, Budget, Quest, Milestone } from '../types';

export class QuestSystem {
    /**
     * Generează quest-uri săptămânale pe baza cheltuielilor curente și a bugetului
     */
    static generateWeeklyQuests(transactions: Transaction[], budget: Budget): Quest[] {
     ...
     */
    static checkQuestProgress(quest: Quest, transactions: Transaction[]): Milestone[] {
