...
export class BunnyAdvisor {
    static async analyzeTransactions(transactions, budget) {
    ...
    static generateWeeklyReport(transactions, budget) {
        const date = new Date();
    ...
    static detectUnusedCategories(transactions, budget) {
        ...
        for (const category of budget.categories) {
            const recentTransactions = transactions.filter(t => t.category === category.name &&
    ...
    static detectOverspending(transactions, budget) {
