...
export function getPeriodRange(currentDate, period, startDay) {
...
export function getPeriodKey(currentDate, period, startDay) {
...
export function getCurrentBudgetPeriod(currentDate, period, startDay) {
    return getPeriodRange(currentDate, period, startDay);
}
export function getPreviousPeriod(currentDate, period, startDay) {
...
export function getNextPeriod(currentDate, period, startDay) {
    const start = dayjs(getPeriodRange(currentDate, period, startDay).start);
    let newStart;
    switch (period) {
        case 'weekly':
